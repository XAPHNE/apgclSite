    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bread-text">
                ...
                <li class="breadcrumb-item"><a href="#" class="bread-text">@lang('navigationMenu.dam_safety') </a></li>
            </ol>
        </nav>
    </div>
</section>
<section class="pt-0">
    <div class="container">
        <div class="row">
            <h4 class="line-vertical">@lang('navigationMenu.dam_safety')</h4>
                        ...
                        @foreach ($damSafeties as $damSafety)
                            @if ($damSafety->visibility)
                                <tr>
                                    ...
                                    <td class="text-start">{{ $damSafety->name }}</td>
                                    <td>
                                        <a href="{{ url($damSafety->downloadLink) }}" target="_blank">
