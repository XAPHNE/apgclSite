    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bread-text">
                ...
                <li class="breadcrumb-item"><a href="#" class="bread-text">@lang('navigationMenu.apprenticeship') </a></li>
            </ol>
        </nav>
    </div>
</section>
<section class="pt-0">
    <div class="container">
        <div class="row">
            <h4 class="line-vertical">@lang('navigationMenu.apprenticeship')</h4>
            <p class="mt-3"><b>
                @lang('apprenticeship.provisions_of_apprenticeship_act')
            </b></p>

             <p class="mt-3"><b>
               @lang('apprenticeship.as_such')
            </b></p>

            <p class="mt-3 mb-3">
               @lang('apprenticeship.note')
            </p>
                        ...
                        @foreach ($apprenticeships as $apprenticeship)
                            @if ($apprenticeship->visibility)
                                <tr>
                                    ...
                                    <td class="text-start">{{ $apprenticeship->name }}</td>
                                    <td>
                                        <a href="{{ url($apprenticeship->downloadLink) }}" target="_blank">
