    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bread-text">
                ...
                <li class="breadcrumb-item"><a href="#" class="bread-text">@lang('navigationMenu.recruitment') </a></li>
            </ol>
        </nav>
    </div>
</section>
<section class="pt-0">
    <div class="container">
        <div class="row">
            <h4 class="line-vertical">@lang('navigationMenu.recruitment')</h4>
                        ...
                        @foreach ($recruitments as $recruitment)
                            @if ($recruitment->visibility)
                                <tr>
                                    ...
                                    <td class="text-start">{{ $recruitment->name }}</td>
                                    <td>
                                        <a href="{{ url($recruitment->downloadLink) }}" target="_blank">
