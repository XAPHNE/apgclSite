    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bread-text">
                ...
                <li class="breadcrumb-item"><a href="#" class="bread-text">NRPP </a></li>
            </ol>
        </nav>
    </div>
</section>
                ...
                <div class="tab-content" id="myTabContent">
                        ...
                        <div class="mt-3 mb-3">
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <td>Name</td>
                                        <td colspan="3">Namrup Replacement Power Plant</td>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td>Total Capacity</td>
                                        <td colspan="3">98.4 MW (1 X 62.25 MW + 1 X 36.15 MW)</td>
                                    </tr>
                                    <tr>
                                        <td>Location</td>
                                    ...
                                    <tr>
                                        <td>By Rail</td>
                                        <td colspan="1">73 KM from Dibrugarh Railway station.</td>
                                    </tr>
                                    <tr>
                                        <td>By Road</td>
                                    ...
                                    <tr>
                                        <td class="align-middle">Date of Commissioning</td>
                                        <td colspan="3">NRPP		--- 	COD on 16th July 2021</td>
                                    </tr>				
                                    <tr>
                                    ...
                                    <table id="generation-table" class="table table-bordered text-center table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Generation Status of NRPP in MU</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                    ...
                    <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                        <div class="mt-3 mb-3">
                            ...
                            @php
                                $contact = App\Models\Contact::where('designation', 'LIKE', '%Namrup Replacement Power Project%')
                                    ->orWhere('designation', 'LIKE', '%NRPP%')
                                    ->orWhere('designation', 'LIKE', '%Namrup Thermal Power Station%')
        ...
        new Chart(ctx, {
            ...
            options: {
                ...
                plugins: {
                    title: { 
                        display: true, 
                        text: 'Total Generation Status NRPP (Last Five Years)', 
                        font: { size: 25 } 
                    }
                }
            }
