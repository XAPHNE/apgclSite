    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bread-text">
                ...
                <li class="breadcrumb-item"><a href="#" class="bread-text">@lang('navigationMenu.projects_in_pipeline') </a></li>
            </ol>
        </nav>
    </div>
</section>
                    ...
                    <tbody>
                        ...
                        @foreach ($projectsInPipelines as $projectsInPipeline)
                            <tr>
                                ...
                                <td class="text-start">{{ $projectsInPipeline->name }}</td>
                                <td class="text-center">{{ $projectsInPipeline->capacity }}</td>
                            </tr>
                        @endforeach
