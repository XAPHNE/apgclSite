    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bread-text">
                ...
                <li class="breadcrumb-item"><a href="#" class="bread-text">@lang('footer.calender_&_holiday') </a></li>
            </ol>
        </nav>
    </div>
</section>
<section class="pt-0">
    <div class="container">
        <div class="row">
            <h4 class="line-vertical">@lang('footer.calender_&_holiday')</h4>
                        ...
                        @foreach ($calendars as $calendar)
                            @if ($calendar->visibility)
                                <tr>
                                    ...
                                    <td class="text-start">{{ $calendar->name }}</td>
                                    <td>
                                        <a href="{{ url($calendar->downloadLink) }}" target="_blank">
