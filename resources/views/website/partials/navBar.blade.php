                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="top-contact-area">
                            <ul>
                                <li>
                                    <a href="#">@lang('header.skip_to_main_content') |</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <div class="dropdown account-details">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            <li>
                                                <a class="dropdown-item" href="https://mail.apgcl.org/">@lang('header.employee_mail')</a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="https://dashboard.apgcl.org/">@lang('header.apgcl_dashboard')</a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="https://epragati.apgcl.org:44900/irj/portal">@lang('header.apgcl_ess/mss_portal')</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
