    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bread-text">
                ...
                <li class="breadcrumb-item"><a href="#" class="bread-text">@lang('footer.csr') </a></li>
            </ol>
        </nav>
    </div>
</section>
<section class="pt-0">
    <div class="container">
        <div class="row">
            <h4 class="line-vertical">@lang('footer.csr')</h4>
                        ...
                        @foreach ($csrs as $csr)
                            @if ($csr->visibility)
                                <tr>
                                    ...
                                    <td class="text-start">{{ $csr->name }}</td>
                                    <td>
                                        <a href="{{ url($csr->downloadLink) }}" target="_blank">
