    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bread-text">
                ...
                <li class="breadcrumb-item"><a href="#" class="bread-text">@lang('navigationMenu.disaster_management') </a></li>
            </ol>
        </nav>
    </div>
</section>
<section class="pt-0">
    <div class="container">
        <div class="row">
            <h4 class="line-vertical">@lang('navigationMenu.disaster_management')</h4>
                        ...
                        @foreach ($disasterManagements as $disasterManagement)
                            @if ($disasterManagement->visibility)
                                <tr>
                                    ...
                                    <td class="text-start">{{ $disasterManagement->name }}</td>
                                    <td>
                                        <a href="{{ url($disasterManagement->downloadLink) }}" target="_blank">
