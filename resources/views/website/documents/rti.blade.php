    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bread-text">
                ...
                <li class="breadcrumb-item"><a href="#" class="bread-text">@lang('navigationMenu.right_to_information') </a></li>
            </ol>
        </nav>
    </div>
</section>
<section class="pt-0">
    <div class="container">
        <div class="row">
            <h4 class="line-vertical">@lang('navigationMenu.right_to_information')</h4>
                        ...
                        @foreach ($rtis as $rti)
                            @if ($rti->visibility)
                                <tr>
                                    ...
                                    <td class="text-start">{{ $rti->name }}</td>
                                    <td>
                                        <a href="{{ url($rti->downloadLink) }}" target="_blank">
