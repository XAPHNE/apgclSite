    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bread-text">
                ...
                <li class="breadcrumb-item"><a href="#" class="bread-text">@lang('navigationMenu.tariff_petition') </a></li>
            </ol>
        </nav>
    </div>
</section>
<section class="pt-0">
    <div class="container">
        <div class="row">
            <h4 class="line-vertical">@lang('navigationMenu.tariff_petition')</h4>
                        ...
                        @foreach ($tariffPetitions as $tariffPetition)
                            @if ($tariffPetition->visibility)
                                <tr>
                                    ...
                                    <td class="text-start">{{ $tariffPetition->name }}</td>
                                    <td>
                                        <a href="{{ url($tariffPetition->downloadLink) }}" target="_blank">
