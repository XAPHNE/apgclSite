    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bread-text">
                ...
                <li class="breadcrumb-item"><a href="#" class="bread-text">@lang('navigationMenu.annual_return') </a></li>
            </ol>
        </nav>
    </div>
</section>
<section class="pt-0">
    <div class="container">
        <div class="row">
            <h4 class="line-vertical">@lang('navigationMenu.annual_return')</h4>
                        ...
                        @foreach ($annualReturns as $annualReturn)
                            @if ($annualReturn->visibility)
                                <tr>
                                    ...
                                    <td class="text-start">{{ $annualReturn->name }}</td>
                                    <td>
                                        <a href="{{ url($annualReturn->downloadLink) }}" target="_blank">
