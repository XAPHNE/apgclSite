    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bread-text">
                ...
                <li class="breadcrumb-item"><a href="#" class="bread-text">@lang('navigationMenu.reports') </a></li>
            </ol>
        </nav>
    </div>
</section>
<section class="pt-0">
    <div class="container">
        <div class="row">
            <h4 class="line-vertical">@lang('navigationMenu.reports')</h4>
                        ...
                        @foreach ($reports as $report)
                            @if ($report->visibility)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url($report->downloadLink) }}" target="_blank">
