    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bread-text">
                ...
                <li class="breadcrumb-item"><a href="#" class="bread-text">@lang('navigationMenu.publication') </a></li>
            </ol>
        </nav>
    </div>
</section>
<section class="pt-0">
    <div class="container">
        <div class="row">
            <h4 class="line-vertical">@lang('navigationMenu.publication')</h4>
                        ...
                        @foreach ($publications as $publication)
                            @if ($publication->visibility)
                                <tr>
                                    ...
                                    <td class="text-start">{{ $publication->name }}</td>
                                    <td>
                                        <a href="{{ url($publication->downloadLink) }}" target="_blank">
