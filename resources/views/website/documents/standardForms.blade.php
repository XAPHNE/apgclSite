    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bread-text">
                ...
                <li class="breadcrumb-item"><a href="#" class="bread-text">@lang('navigationMenu.standard_forms') </a></li>
            </ol>
        </nav>
    </div>
</section>
<section class="pt-0">
    <div class="container">
        <div class="row">
            <h4 class="line-vertical">@lang('navigationMenu.standard_forms')</h4>
            <div class="table-responsive">
                <table id="table" class=" table-bordered table table-striped" style="width:100%">
                    <thead>
                        <tr class="bg-primary">
                            <th width="10%">@lang('table.serial_num')</th>
                        ...
                        @foreach ($standardForms as $standardForm)
                            @if ($standardForm->visibility)
                                <tr>
                                    ...
                                    <td class="text-start">{{ $standardForm->name }}</td>
                                    <td>
