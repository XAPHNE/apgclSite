    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bread-text">
                ...
                <li class="breadcrumb-item"><a href="#" class="bread-text">@lang('navigationMenu.tariff_order') </a></li>
            </ol>
        </nav>
    </div>
</section>
                        ...
                        @foreach ($tariffOrders as $tariffOrder)
                            @if ($tariffOrder->visibility)
                                <tr>
                                    ...
                                    <td class="text-start">{{ $tariffOrder->name }}</td>
                                    <td>
                                        <a href="{{ url($tariffOrder->downloadLink) }}" target="_blank">
