...
@section('content')
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row text-center mb-2">
                        <h4 class="card-title">Standard Forms Table</h4>
                        <button onclick="scrollFunction()" class="btn btn-success  ml-auto">Add
                            Data</button> <!-- scrollFuction -used for -->
                    </div>
                    <table class="table table-striped datatable" id="standard" style="width: 100%">
                        <thead>
                            <tr>
        ...
        <div id="addDetails" class="col-lg-12 grid-margin strech-card">
            <div class="card">
                <div class="card-body">
                    <form name="add_standard" id="add_standard" class="needs-validation" novalidate>
                        <!-- validation code -->
                        @csrf
                        <!-- input description -->
                        <div class="row mb-4">
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editModalLabel">Edit Standard Details</h5>
                ...
                <div class="modal-body">
                    <div class="col-lg-12 grid-margin strech-card">
                        <div class="card">
                            <div class="card-body">
                                <form name="edit_standard" id="edit_standard" method="post"
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteModalLabel">Delete Standard Details</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form name="delete_standard" id="delete_standard">
                        @csrf
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#standard').DataTable({
                ...
                ajax: "{{ route('standard-forms.index') }}",
            ...
            // Add Details
            $('#add_standard').submit(function(e) {
                e.preventDefault();
            ...
            $(document).on('click', '.editBtn', function() {
                ...
                $.ajax({
                    type: "get",
                    url: "/standard-forms/"+id+"/edit",
                    success: function(response) {
                        $('#standardID').val(id)
                        $('#editDescription').val(response.standard.description);
                        $('#fileLink').val(response.standard.downloadLink);
                    }
                });

                // update data

                $('#edit_standard').submit(function(e) {
            ...
            $('#delete_standard').submit(function(e) {
