...
@section('content')
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row text-center mb-2">
                        <h4 class="card-title">Annual Return</h4>
                        <button onclick="scrollFunction()" class="btn btn-success  ml-auto">Add
                            Data</button> <!-- scrollFuction -used for -->
                    </div>
                    <table class="table table-striped datatable" id="annualreturn" style="width: 100%">
                        <thead>
                            <tr>
        ...
        <div id="addDetails" class="col-lg-12 grid-margin strech-card">
            <div class="card">
                <div class="card-body">
                    <form name="add_annualreturn" id="add_annualreturn" method="post"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#annualreturn').DataTable({
                ...
                ajax: "{{ route('annual-return.index') }}",
            ...
            // Add Details
            $('#add_annualreturn').submit(function(e) {
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if(response.code == 0){                            
                            ...
                            $('#add_annualreturn').trigger('reset');
                                Swal.fire({
                                icon: 'success',
            ...
            $(document).on('click', '.editBtn', function() {
                ...
                $.ajax({
                    type: "get",
                    url: "/annual-return/"+id+"/edit",
                    success: function(response) {
                        $('#annualreturnID').val(id)
                        $('#editDescription').val(response.annualreturn.description);
                        $('#fileLink').val(response.annualreturn.downloadLink);
                ...
                $('#edit_annualreturn').submit(function(e) {
            ...
            $('#delete_annualreturn').submit(function(e) {
