...
@section('content')
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row text-center mb-2">
                        <h4 class="card-title">Tariff Order Table</h4>
                        <button onclick="scrollFunction()" class="btn btn-success  ml-auto">Add
                            Data</button> <!-- scrollFuction -used for -->
                    </div>
                    <table class="table table-striped datatable" id="tariffOrder" style="width: 100%">
                        <thead>
                            <tr>
        ...
        <div id="addDetails" class="col-lg-12 grid-margin strech-card">
            <div class="card">
                <div class="card-body">
                    <form name="add_tariffOrder" id="add_tariffOrder" method="post"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col-lg-12 grid-margin strech-card">
                        <div class="card">
                            <div class="card-body">
                                <form name="edit_tariffOrder" id="edit_tariffOrder" method="post"
                                    class="needs-validation" novalidate>
                                    <!-- validation code -->
                                    @csrf
                                    @method('PUT')

                                    <input type="hidden" name="tariffOrderID" id="tariffOrderID">
...
@section('js')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            // Add Details
            $('#add_tariffOrder').submit(function(e) {
            ...
            $(document).on('click', '.editBtn', function() {
                ...
                $.ajax({
                    type: "get",
                    url: "/tariff-order/"+id+"/edit",
                    success: function(response) {
                        $('#tariffOrderID').val(id);
                        $('#editDescription').val(response.tariffOrder.description);
                        $('#edituploadFilelink').val(response.tariffOrder.downloadLink);
                    }
                });

                // update data
                $('#edit_tariffOrder').submit(function(e) {
                    ...
                    $.ajax({
                        ...
                        if(response.code == 0){                            
                            ...
                            printErrorMsg(response.error);
                                ...
                                $('#edit_tariffOrder').trigger('reset');
                                Swal.fire({
                                icon: 'success',
                                title:'Your Data has been Saved',
                                showConfirmButton: false,
