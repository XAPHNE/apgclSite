...
@section('title', 'Annual Statement')

@section('content_header')
    <h1>Annual Statement</h1>
@stop
...
@section('content')
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row text-center mb-2">
                        <h4 class="card-title">Annual Statement</h4>
                        <button onclick="scrollFunction()" class="btn btn-success  ml-auto">Add
                            Data</button> <!-- scrollFuction -used for -->
                    </div>
                    <table class="table table-striped datatable" id="annualstatement"
                        style="width: 100%">
                        <thead>
                            <tr>
        ...
        <div id="addDetails" class="col-lg-12 grid-margin strech-card">
            <div class="card">
                <div class="card-body">
                    <form name="add_annualstatement" id="add_annualstatement" method="post"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col-lg-12 grid-margin strech-card">
                        <div class="card">
                            <div class="card-body">
                                <form name="edit_annualstatement" id="edit_annualstatement" method="post"
                                    class="needs-validation" novalidate>
                                    <!-- validation code -->
                                    @csrf
                                    @method('PUT')

                                    <input type="hidden" name="annualstatementID" id="annualstatementID">
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteModalLabel">Delete Annualstatement Details</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form name="delete_annualstatement" id="delete_annualstatement">
                        @csrf
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#annualstatement').DataTable({
                ...
                ajax: "{{ route('annual-statement.index') }}",
            ...
            // Add Details
            $('#add_annualstatement').submit(function(e) {
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if(response.code == 0){                            
                            ...
                            $('#add_annualstatement').trigger('reset');
                                Swal.fire({
                                icon: 'success',
            ...
            $(document).on('click', '.editBtn', function() {
                ...
                $.ajax({
                    type: "get",
                    url: "/annual-statement/"+id+"/edit",
                    success: function(response) {
                        $('#annualstatementID').val(id)
                        $('#editDescription').val(response.annualstatement.description);
                        $('#fileLink').val(response.annualstatement.downloadLink);
                ...
                $('#edit_annualstatement').submit(function(e) {
            ...
            $('#delete_annualstatement').submit(function(e) {
